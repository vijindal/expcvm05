    ...
    public void funcsOpt(ExptDatum datum_in, double[] dyda_out) throws IOException {//vj-2013-04-01-funcs for OptMrq
        ...
        switch (datum_in.getBList()) {
            ...
            case "COPT": {
                ...
                //datum.setX(modData[1]);//vj-2013-04-01
...
//                dyda_temp1 = Mat.mul(Mat.transpose(emat1), dyda_temp1);
            ...
            case "CX32T"://Three phase with one phase decomposing
            case "CX33T": {
//                pIndex[0] = getPid(datum_in.getPid(0, 0), datum_in.getPid(0, 1));
//                pIndex[1] = getPid(datum_in.getPid(1, 0), datum_in.getPid(1, 1));
//                phase0 = setPhase(datum_in.getPid(0, 0), pIndex[0]);
//                phase1 = setPhase(datum_in.getPid(1, 0), pIndex[1]);
//                double a_local1[] = new double[phase0.getNP()];
//                double a_local2[] = new double[phase1.getNP()];
                double dyda_local[] = new double[phase0.getNP() + phase1.getNP()];
//                System.arraycopy(a_In, Globals.getAindex(pIndex[0]), a_local1, 0, a_local1.length);
//                System.arraycopy(a_In, Globals.getAindex(pIndex[1]), a_local2, 0, a_local2.length);
//                double[] eTrans_local1 = Mat.mul(phase0.getETrans(), a_local1);
//                double[] eTrans_local2 = Mat.mul(phase1.getETrans(), a_local2);
//                setei(eTrans_local1, eTrans_local2);
                modData = new double[4];//vj-2012-05-21
...
//                pIndex[0] = getPid(datum_in.getPid(0, 0), datum_in.getPid(0, 1));
//                pIndex[1] = getPid(datum_in.getPid(1, 0), datum_in.getPid(1, 1));
//                pIndex[2] = getPid(datum_in.getPid(2, 0), datum_in.getPid(2, 1));
//                phase0 = setPhase(datum_in.getPid(0, 0), pIndex[0]);
//                phase1 = setPhase(datum_in.getPid(1, 0), pIndex[1]);
//                phase2 = setPhase(datum_in.getPid(2, 0), pIndex[2]);
//                double a_local1[] = new double[phase0.getNP()];
//                double a_local2[] = new double[phase1.getNP()];
//                double a_local3[] = new double[phase2.getNP()];
                double dyda_local[] = new double[phase0.getNP() + phase1.getNP() + phase2.getNP()];
//                System.arraycopy(a_In, Globals.getAindex(pIndex[0]), a_local1, 0, a_local1.length);
//                System.arraycopy(a_In, Globals.getAindex(pIndex[1]), a_local2, 0, a_local2.length);
//                System.arraycopy(a_In, Globals.getAindex(pIndex[2]), a_local3, 0, a_local3.length);
//                double[] eTrans_local1 = Mat.mul(phase0.getETrans(), a_local1);
//                double[] eTrans_local2 = Mat.mul(phase1.getETrans(), a_local2);
//                double[] eTrans_local3 = Mat.mul(phase2.getETrans(), a_local3);
//                setei(eTrans_local1, eTrans_local2, eTrans_local3);
                modData = new double[4];//vj-2012-05-21
                initi(datum_in, modData);//vj-2012-05-21
...
//                double[][] emat1 = new double[phase1.getNP()][phase1.getNP()];
//                phase1.getETrans(emat1);
//                double[][] emat2 = new double[phase2.getNP()][phase2.getNP()];
//                phase2.getETrans(emat2);
//                dyda_temp0 = Mat.mul(Mat.transpose(emat0), dyda_temp0);
//                dyda_temp1 = Mat.mul(Mat.transpose(emat1), dyda_temp1);
//                dyda_temp2 = Mat.mul(Mat.transpose(emat2), dyda_temp2);
                int pIndex0 = phasedata.getPid(datum_in.getPid(0, 0), datum_in.getPid(0, 1), datum_in.getPid(0, 2));
                int pIndex1 = phasedata.getPid(datum_in.getPid(1, 0), datum_in.getPid(1, 1), datum_in.getPid(1, 2));
...
//                System.arraycopy(dyda_local, 0, a_local1, 0, a_local1.length);
//                System.arraycopy(dyda_local, a_local1.length, a_local2, 0, a_local2.length);
//                System.arraycopy(dyda_local, a_local1.length + a_local2.length, a_local3, 0, a_local3.length);
//                a_local1 = Mat.mul(Mat.transpose(phase0.getETrans()), a_local1);
//                a_local2 = Mat.mul(Mat.transpose(phase1.getETrans()), a_local2);
//                a_local3 = Mat.mul(Mat.transpose(phase2.getETrans()), a_local3);
//                System.arraycopy(a_local1, 0, dyda_out, Globals.getAindex(pIndex[0]), a_local1.length);
//                System.arraycopy(a_local2, 0, dyda_out, Globals.getAindex(pIndex[1]), a_local2.length);
//                System.arraycopy(a_local3, 0, dyda_out, Globals.getAindex(pIndex[2]), a_local3.length);
                phase0 = null;
                phase1 = null;
                phase2 = null;
                modData = null;
    ...
    private void initCXT(ExptDatum datum, double[] modDataIn) throws IOException {//vj-2012-07-04//Returns initial compositions for MG 
        ...
        //prnt.f(phase0.getPhaseTag());
        //prnt.f(phase1.getPhaseTag());
//        double[][] GList = phase0.calGList(modDataIn[0]);
//        double[][] GList1 = phase1.calGList(modDataIn[0]);
    }

    private void initCXX(ExptDatum datum, double[] modDataIn) throws IOException {//vj-2012-07-04//Returns initial compositions for MG 
        Print.f("Model.initCXX() method called", 7);
        Print.f("dindex = " + datum.getdIndex(), 7);
        //Prnt.f(modData, "ModdataIn", "printing moddata input to CXX");
        modDataIn[0] = datum.getYmod();
        modDataIn[1] = datum.getX();
        modDataIn[2] = datum.getX1();
        modDataIn[3] = datum.getX2();
        //Prnt.f(modData, "ModdataIn", "printing moddata output from CXX");
        Print.f(phase0.getPhaseTag(), 7);
        Print.f(phase1.getPhaseTag(), 7);
        double[][] GList = calGList(modDataIn[1], 0.01, phase0);

        //prnt.f(GList, "GList-phase0", 1);
        double[][] GList1 = calGList(modDataIn[1], 0.01, phase1);
        //prnt.f(GList1, "GList-phase1", 1);
        //prnt.f(GList, "GList-phase0", 1);
        //prnt.f(GList1, "GList-phase1", 1);

        //System.out.printf("Glist calculated");
        for (int i = 0; i < 101; i++) {
            //System.out.printf("%lf  %lf",GList[i])
            if (GList[i][1] > GList1[i][1]) {
                GList[i][1] = GList1[i][1];
            }
        }
        // Print.f(GList, "Merged GList", 1);
        double[][] G = new double[101][2];
        double xTrial, GTrial;
        //boolean iStable;
        boolean iLeft;
        ...
        modDataIn[0] = xl;
        modDataIn[2] = xr;
        Print.f("Model.initCXX() method ended ", 7);//with xl:"+xl+", xr:"+xr, 1);
    }
    ...
    public void calHm(double[] modDataIn) throws IOException {
        ...
        //Output
        modDataIn[0] = H_local;
        //System.out.println(modDataIn[0]);
    ...
    public void calG(double[] modDataIn) throws IOException {//vj-2012-05-17
        Print.f(phase0.getPhaseTag() + ".calG() method called", 7);
        //Initialization
        double G_local;//y:Free Energy
        double T_local = modDataIn[1];//x:Composition
        double x_local = modDataIn[2];//param:Temperature
    ...
    public double[][] calGList(double T_in, double xIntvl, PHASEBINCE phase) throws IOException {//Mani-2013-03-06
        ...
        double[] moddata = {0.0, 0.00, T_in, 0.0};//Initia composition and temperature
        int il;
        {
            moddata[1] = 0.00;
            for (il = 1; il < nIntvl; il = il + 1) {
                moddata[1] = moddata[1] + (1 / (double) nIntvl);
                calG(moddata);
                GxxN = phase.calDGxx();
                GListLocal[il][0] = moddata[1];//Composition
                GListLocal[il][1] = moddata[0];//Free Energy
                //System.out.println("il:" + il + ", modData[1]:" + modData[1] + ", GxxN:" + GxxN);
                if ((moddata[1] > (1 - (1 / (double) nIntvl))) || (GxxN < epsGxx)) {
                    il = il - 1;
                    break;
                }
            }
        ...
        int ir;
        if (moddata[1] < (1 - (1 / (double) nIntvl))) {//if composition not reached 0.99, start again from right side
            moddata[1] = 1.00;
            for (ir = nIntvl - 1; ir > 0; ir = ir - 1) {
                moddata[1] = moddata[1] - (1 / (double) nIntvl);
                calG(moddata);
                GxxN = phase.calDGxx();
                GListLocal[ir][0] = moddata[1];//Composition
                GListLocal[ir][1] = moddata[0];//Free Energy
                //System.out.println("ir:" + ir + ", modData[1]:" + modData[1] + ", GxxN:" + GxxN);
                if ((moddata[1] < (1 / (double) nIntvl)) || (GxxN < epsGxx)) {
                    ir = ir + 1;
                    break;
                }
            }
            moddata[1] = GListLocal[il][0];
            double GSlope = ((GListLocal[ir][1] - GListLocal[il][1]) / (ir - il));
            for (int i = il + 1; i < ir; i++) {
                moddata[1] = moddata[1] + (1 / (double) nIntvl);
                GListLocal[i][0] = moddata[1];//Composition
    ...
    public void calMGXA(double[] modDataIn) throws IOException {//2012-02-23(VJ): Added
        ...
        //double x0_local = modDataIn[0];//y:Composition of alfa phase
        //double x1_local = modDataIn[2];//Paramater:Composition of beta phase

        double T_local = modDataIn[1];//x:Temperature
        double x0_local = modDataIn[2];//y:Composition of alfa phase
        double x1_local = modDataIn[3];//Paramater:Composition of beta phase
        //calculation
        int ntrial = 20;
        int counter;
        double tolf = 1E-06;
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            Print.f("Iteration:" + counter + ", T_local:" + T_local + ", x0_local:" + x0_local + ", x1_local:" + x1_local + ", errf:" + errf, 3);
            if (errf <= tolf) {
                Print.f("PHASEmBINCE:calMGX1() ended with T_local:" + T_local + ", x0_local:" + x0_local + ", x1_local:" + x1_local + ", errf:" + errf, 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax0 = Utils.stpmaX(x0_local, x0_local + delX[0]);
            double stpmax1 = Utils.stpmaX(x1_local, x1_local + delX[1]);
            double stpmax = Math.min(stpmax0, stpmax1);
            x0_local = x0_local + stpmax * delX[0];
            x1_local = x1_local + stpmax * delX[1];
            Print.f("T_local:" + T_local + ", x0_local:" + x0_local + ", x1_local:" + x1_local + ", stpmax:" + stpmax + ", errf:" + errf, 2);
        }
        if (counter == ntrial) {
            Print.f("PHASEmBINCE.calMGX1() ntrial reached with errf:" + errf + "\t!", 1);
        }
        //modDataIn[1] = T_local;
        //modDataIn[0] = x0_local;
        //modDataIn[2] = x1_local;
        modDataIn[0] = x0_local;
        modDataIn[1] = T_local;
        modDataIn[2] = x0_local;
        modDataIn[3] = x1_local;
        Print.f(phase0.getPhaseTag() + ".calMGX1() method ended", 7);
    }

    public void calMGXA(double[] modDataIn, double[] dydaIn) throws IOException {//2012-02-23(VJ): Added
    ...
    public void calMGXB(double[] modDataIn) throws IOException {//2012-02-23(VJ): Added
        Print.f("PHASEmBINCE.calMGX2() method called", 7);
        //Initialization
        //double T_local = modDataIn[1];//x:Temperature
        //double x0_local = modDataIn[2];//x2:Composition of alfa phase
        //double x1_local = modDataIn[0];//y:Composition of beta phase
        double T_local = modDataIn[1];//x:Temperature
        double x0_local = modDataIn[2];//y:Composition of alfa phase
        double x1_local = modDataIn[3];//Paramater:Composition of beta phase
        //calculation
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            x0_local = x0_local + stpmax * delX[0];
            x1_local = x1_local + stpmax * delX[1];
            //prnt.f("T_local:" + T_local + ", x0_local:" + x0_local + ", x1_local:" + x1_local + ", stpmax:" + stpmax + ", errf:" + errf, 2);
        }
        if (counter == ntrial) {
    ...
    public void calMGXB(double[] modDataIn, double[] dydaIn) throws IOException {//2012-02-23(VJ): Added
        Print.f("PHASEmBINCE.calMGX2() method called", 7);
        //Initialization
        //double T_local = modDataIn[1];//x:Temperature
        //double x0_local = modDataIn[2];//x2:Composition of alfa phase
    ...
    public void calMGTA(double[] modDataIn) throws IOException {//2012-02-23(VJ): Added
        ...
        double T_local = modDataIn[1];//x:Temperature
        double x0_local = modDataIn[2];//x2:Composition of alfa phase
        double x1_local = modDataIn[3];//y:Composition of beta phase
        //calculation
        int ntrial = 40;
        int counter;
        double tolf = 1E-06;
    ...
    public void calMGTA(double[] modDataIn, double[] dydaIn) throws IOException {//2012-02-23(VJ): Added
        Print.f("PHASEmBINCE.calMGT1() method called", 7);
        //Initialization
    ...
    public void calMGTB(double[] modDataIn) throws IOException {//2012-02-23(VJ): Added,2012-03-13(VJ): Modified
    ...
    public void calMGTB(double[] modDataIn, double[] dydaIn) throws IOException {//2012-02-23(VJ): Added,2012-03-13(VJ): Modified
        Print.f("PHASEmBINCE.calMGT2() method called", 7);
        //Initialization
        //double T_local = modDataIn[0];//y:Temperature
        //double x0_local = modDataIn[2];//x1:Composition of alfa phase
    ...
    public void calCOPT(double[] modData) throws IOException {//vj-2012-04-12
        ...
        for (int iter = 0; iter < maxIterations; iter++) {
            ...
            if ((Math.abs(DGxxN) <= errGxx) && (Math.abs(DGxxxN) <= errGxxx)) {
                modData[0] = T_local;
                modData[1] = x_local;
                Print.f("Methods.calCOPT() executed with DGxxN:" + DGxxN + ", DGxxxN:" + DGxxxN, 2);
                return;
            }
            double delT = -DGxxN / DGTxxN;
        ...
        modData[0] = T_local;
        modData[1] = T_local;//19-04-25: changed from x_local to T_local
        modData[2] = x_local;
    ...
    public void calCXXA(double[] modDataIn) throws IOException {//2012-02-27(VJ): Added
        ...
        //Initialization
        //double T_local = modDataIn[1];//x:Temperature                             //vj-2021-01-18
        //double x0_local = modDataIn[0];//y:Composition of alfa phase              //vj-2021-01-18
        //double x1_local = modDataIn[2];//Paramater:Composition of beta phase      //vj-2021-01-18
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            if (errf <= tolf) {
                Print.f("Model:calCXXA() ended with T_local:" + T_local + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax0 = Utils.stpmaX(x0_local, x0_local + delX[0]);
            ...
            x0_local = x0_local + stpmax * delX[0];
            x1_local = x1_local + stpmax * delX[1];
            Print.f("T_local:" + T_local + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", stpmax:" + stpmax + ", errf:" + df.format(errf), 3);
        }
        //Output
        //modDataIn[0] = x0_local;                   //vj-2021-01-18
        // modDataIn[1] = T_local;                    //vj-2021-01-18
        //modDataIn[2] = x1_local;                   //vj-2021-01-18
        ...
        if (counter == ntrial) {
            double[] MU1N = phase1.calGAB();////MUA, MUB of beta phase  calculated at xB
            Print.f("!Model:calCXXA() not coverged and ended with T_local:" + df.format(T_local) + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
        }
        Print.f("Model:calCXXA() method called", 7);
    }
    ...
    public void calCXXA(double[] modDataIn, double[] dydaIn) throws IOException {//2012-02-27(VJ): Added
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            if (errf <= tolf) {
                Print.f("Model:calCXXA() ended with T_local:" + df.format(T_local) + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax0 = Utils.stpmaX(x0_local, x0_local + delX[0]);
            ...
            x0_local = x0_local + stpmax * delX[0];
            x1_local = x1_local + stpmax * delX[1];
            Print.f("T_local:" + df.format(T_local) + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", stpmax:" + stpmax, 3);
        }
    ...
    public void calCXXB(double[] modDataIn) throws IOException {//2012-02-27(VJ): Added
        ...
        double T_local = modDataIn[1];//x:Temperature                           //vj-2021-01-18
        double x0_local = modDataIn[2];//x2:Composition of alfa phase           //vj-2021-01-18
        double x1_local = modDataIn[3];//y:Composition of beta phase            //vj-2021-01-18
        //calculation
        int ntrial = 50;
        int counter;
        double tolf = 1E-06;
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            if (errf <= tolf) {
                Print.f("Model:calCXXB() ended with T_local:" + df.format(T_local) + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax0 = Utils.stpmaX(x0_local, x0_local + delX[0]);
        ...
        modDataIn[1] = T_local;
        modDataIn[2] = x0_local;
        modDataIn[3] = x1_local;                            //vj-2021-01-18
    ...
    public void calCXXB(double[] modDataIn, double[] dydaIn) throws IOException {//2012-02-27(VJ): Added
        ...
        double T_local = modDataIn[1];//x:Temperature
        double x0_local = modDataIn[2];//x2:Composition of alfa phase
        double x1_local = modDataIn[3];//y:Composition of beta phase    //201006-modDataIn[0] changed to modDataIn[3]
        //double x1_local = modDataIn[0];//y:Composition of beta phase
        //calculation
        int ntrial = 20;
        int counter;
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            x0_local = x0_local + stpmax * delX[0];
            x1_local = x1_local + stpmax * delX[1];
            Print.f("T_local:" + T_local + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", stpmax:" + stpmax, 3);
        }
        DMU0e0N = phase0.calDMUe();
        DMU1e1N = phase1.calDMUe();
        Matrix A = new Matrix(fjac);
    ...
    public void calCXTA(double[] modDataIn) throws IOException {
        ...
        //Initialization
        //double T_local = modDataIn[0];//x:Temperature                     //vj-2021-01-18                     
        //double x0_local = modDataIn[1];//x2:Composition of alfa phase     //vj-2021-01-18
        //double x1_local = modDataIn[2];//y:Composition of beta phase      //vj-2021-01-18
        double T_local = modDataIn[1];//x:Temperature
        double x0_local = modDataIn[2];//x2:Composition of alfa phase
        double x1_local = modDataIn[3];//y:Composition of beta phase
        //calculation
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            if (errf <= tolf) {
                Print.f("Model:calCXTA() ended with T_local:" + df.format(T_local) + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax = Utils.stpmaX(x1_local, x1_local + delX[1]);
            T_local = T_local + stpmax * delX[0];
            x1_local = x1_local + stpmax * delX[1];
            Print.f("T_local:" + T_local + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", stpmax:" + stpmax, 3);
        }
        //Output
        //modDataIn[0] = T_local;           //vj-2021-01-18
        //modDataIn[1] = x0_local;          //vj-2021-01-18
        //modDataIn[2] = x1_local;          //vj-2021-01-18
        modDataIn[0] = T_local;
        modDataIn[1] = T_local;
        modDataIn[2] = x0_local;
    ...
    public void calCXTA(double[] modDataIn, double[] dydaIn) throws IOException {
        ...
        double x1_local = modDataIn[3];//y:Composition of beta phase
        //Print.f("T_local",T_local,0);
        //Print.f("x0_local",x0_local,0);
        //Print.f("x1_local",x1_local,0);
        //calculation
        int ntrial = 20;
        int counter;
        double tolf = 1E-06;
        ...
        for (counter = 0; counter < ntrial; counter++) {
            ...
            if (errf <= tolf) {
                Print.f("Model:calCXTA() ended with T_local:" + T_local + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax = Utils.stpmaX(x1_local, x1_local + delX[1]);
    ...
    public void calCXTB(double[] modDataIn) throws IOException {
        ...
        //double T_local = modDataIn[0];//x:Temperature                     //vj-2021-01-18
        //double x0_local = modDataIn[2];//x2:Composition of alfa phase     //vj-2021-01-18
        //double x1_local = modDataIn[1];//y:Composition of beta phase     //vj-2021-01-18
        double T_local = modDataIn[1];//x:Temperature
        double x0_local = modDataIn[2];//x2:Composition of alfa phase
        double x1_local = modDataIn[3];//y:Composition of beta phase
        //calculation
        ...
        int counter;
        //double tolf = 1E-06;
        double tolf = ((("A2ORCBINCE".equals(phase0.getPhaseTag())) && (x0_local < 0.02)) ? 10 : 1E-06);
        double errf = 0;
        int n = 2;
        double fvec[] = new double[2];
        double fjac[][] = new double[2][2];
        for (counter = 0; counter < ntrial; counter++) {
            ...
            if (errf <= tolf) {
                Print.f("Model:calCXTB() ended with T_local:" + T_local + ", x0_local:" + df.format(x0_local) + ", x1_local:" + df.format(x1_local) + ", errf:" + df.format(errf) + ", MUA:" + MU1N[0] + ", MUB:" + MU1N[1], 2);
                break;
            }
            double[] delX = Mat.LDsolve(fjac, fvec);
            double stpmax0 = Utils.stpmaX(x0_local, x0_local + delX[1]);
        ...
        //Output
        //modDataIn[0] = T_local;           //vj-2021-01-18
        //modDataIn[2] = x0_local;          //vj-2021-01-18
        //modDataIn[1] = x1_local;          //vj-2021-01-18
        modDataIn[0] = T_local;
        modDataIn[1] = T_local;
        modDataIn[2] = x0_local;
        modDataIn[3] = x1_local;
    ...
    /*
    201006-input parameters changed 
    @param modDataIn {ymod-T, T, xalfa, xbeta}
    @param  dydaIn
     */
    ...
    public void calCX32(double[] modDataIn, double[] dyda_in) throws IOException {//VJ-2013-06-20 //alfa phase independent and used in making mu equations
        Print.f("Model:calCX31() method called", 7);
    ...
    private void setPhase(ExptDatum datum) throws IOException {
        ...
        while ((ip < 3) && (pid[ip][0] != null)) {
            pType = pid[ip][0];
            pModel = pid[ip][1];//vj-2013-05-19
            pInstance = pid[ip][2];//vj-2013-05-19
